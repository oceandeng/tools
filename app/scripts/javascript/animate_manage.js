/* 
* @Author: ocean
* @Date:   2016-02-21 14:52:31
* @Last Modified by:   ocean
* @Last Modified time: 2016-02-21 21:31:41
*/
...
;(function(window, document, undefined){
	...
	*/
	...
	animateManage.prototype = {
		...
		start: function(options){				//开始动画
			if(options){						
				this.pushQueue(options);		//填充队列属性
			}
		...
		go: function(_options, i){				//执行具体的动画业务
			...
			if(n >= t){							//如果当前的时间 > 开始时间 + 结束时间， 则停止当前动画
				_aniQueue[i] = null;
				this.delQueue();
			} else {
				tPos = this.aniEffect({
