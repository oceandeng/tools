...
(function() {
    ...
    b.Type.extend({
        ...
        initialize: function(a) {
            ...
            this.buildScale(a.labels), this.BarClass.prototype.base = this.scale.endPoint, this.eachBars(function(a, b, d) {
                c.extend(a, {
...
(function(a) {
    flux.slider = function(b, c) {
        ...
        this.height = this.options.height ? this.options.height : null, this.width = this.options.width ? this.options.width : null;
        var f = [];
...
(function(a) {
    ...
    l.bindAfterRenderEvent("s", function(a, b) {}), 
    l.bindAfterRenderEvent("i", function(b, c) {
        if ("view" == l.mode) {
